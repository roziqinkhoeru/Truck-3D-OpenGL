...
#include "environment\FieldT.cpp"
#include "vehicle\ParckingT.cpp"
#include "vehicle\ParckingMiniT.cpp"
#include "vehicle\AnimationT.cpp"
#include "environment\SpbuT.cpp"
#include "environment\house.cpp"

float angle=0.0, deltaAngle = 0.0, ratio;
float x=0.0f,y=2.75f,z=15.0f; // posisi awal kamera
...
// Kalau move dan angle tidak nol, gerakkan kamera...
	...
	drawStrokeChar(score+48,x-1,y-3,z-20);
	glutSwapBuffers();
	glFlush();
}
