...
void CatBox(){
	float R = 80, G = 20, B = 8;//ubah nilainya buat warnai
	
	glColor3ub(R,G,B);
}

void CatBox2(){
	float R = 100, G = 100, B = 100;//ubah nilainya buat warnai
...
void TumpukanBox(){
	glPushMatrix();
		glTranslatef(30,-1.4,50);
		glRotated(60,0,1,0);
		BoxNganggur2();
	glPopMatrix();
	glPushMatrix();
		glTranslatef(24,-1.4,20);
		glRotated(-60,0,1,0);
		BoxNganggur();
	glPopMatrix();
	glPushMatrix();
		glTranslatef(26.2,-1.4,16);
		glRotated(-60,0,1,0);
		BoxNganggur2();
	glPopMatrix();
	glPushMatrix();
		glTranslatef(26,3.15,20);
		glRotated(-55,0,1,0);
		BoxNganggur();
	glPopMatrix();
}

void DisplayMiniTrukParkir() { //atur letak mini trul
	glPushMatrix();
