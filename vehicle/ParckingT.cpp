...
void PosisiParkir(){
	int x = -38, y = 0, z = -32;//parkir
	glTranslatef(x,y,z);
	glRotated(-120,0,1,0);//value angle hadap belakang -180, depan 0 untuk parkir angle = -120
}

//warna Truk
void CatTrukParkir(){
	float R = 130, G = 30, B = 8;//ubah nilainya buat warnai
...
void TrukParkir(){
glPushMatrix();
	PosisiParkir();//implementasi mengatur tempat parkirnya
...
//		glColor3ub(255, 0, 0);//exred
	...
	glRotated(90, 1, 0, 0);
	glBegin(GL_QUADS);
		CatTrukParkir();//warna, awal uk. 5x4
		glVertex3f(0.0f,0.0f,0.0f);
		glVertex3f(18.0f,0.0f,0.0f);
		glVertex3f(18.0f,4.0f,0.0f);
		glVertex3f(0.0f,4.0f,0.0f);
